...
/**
 * Clase Consecuencia la cual va a representar las consecuencias que tienen las acciones de las cartas.
 * @author Leticia
 *
 */
public class Consecuencia {
	...
	private int id;
	/** El tipo de consecuencia que se puede producir**/
	...
	/**
	 * Constructor de la clase Consecuencia, donde se va a crear un objeto, que va a contener un id, un tipo de consecuencia, 
	 * el id de la acción que desencadena la consecuencia y el número de la carta que tiene la accionId
	 ...
	 * @param esPositivaNos dice si la conseciencia es positiva o no (1 positiva, 0 negativa)
	...
	/**
	 * Función toString que nos devuelve una String con los datos del id de la consecuencia, el tipo de consecuencia, si es positiva
	 * o no, el id de la acción que desencade la consecuencia, y la carta que contiene esa acción.
	 */
	@Override
