...
/**
 * Clase que representa las acciones que puede realizar el personaje. Las
 * acciones se encuentra en los distintos tipos de carta.
 * 
 * @author Leticia
 *
 */
public class Accion {
	...
	/** Las consecuencias positivas que tendrá la acción al ser resuelta **/
	 ...
	 * a estar compuesto por el id, el tipo de acción, la descripción de la misma,
	 * el coste de energía que va a tener la acción, la dificultad y el número de
	 * carta donde se encuentra la acción.
	 * 
	 ...
	 * 
	 * @return Nos devuelve las consecuencias positivas al resolver una acción
	 */
	 ...
	 * 
	 * @return Nos devuelve las consecuencias negativas que puede tener una acción al ser resuelta
	 */
	...
	/*
	 * Función toString de la clase Acción. Nos devuelve una String con el id de la
	 * acción, el tipo, la descripción de la misma, y las consecuencias positivas y
	 * negativas que pudiera tener esa acción
	 */
	@Override
	public String toString() {
		...
		return "[" + id + "][" + tipoAccion + "] '" + descripcion + "'" + "\n" + "Consecuencias positivas: "
				+ consecuenciasPositivasString + "\n" + "Consecuencias negativas: " + consecuenciasNegativasString;
	}
