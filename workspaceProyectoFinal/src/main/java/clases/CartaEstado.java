...
public class CartaEstado extends Carta{
	/** El título del estado que puede tener el personaje **/
	private String tituloEstado;

	/**
	 * Constructor de la clase CartaEstado, que se va a componer de un id, un número de carta, un texto descriptivo de la carta,
	 * la ruta de la imagen de la carta, y un título del estado que puede tener el personaje
