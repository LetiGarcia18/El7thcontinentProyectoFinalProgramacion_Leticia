...
public class CartaEnMapa extends Carta {
	...
	/**
	 * Constructor de la clase CartaEnMapa, donde se va a crear un objeto que se va
	 * a componer de un id, un número de carta, una ruta de la imagen donde se
	 * encuentra la carta, un texto descriptivo de lo que está ocurriendo en esa
	 * carta, la posición X y la posición Y de la carta.
	 * 
	 * @param id                     Id de la carta
	 * @param numeroCarta            El número de la carta
	 * @param rutaImagen             La ruta de la imagen de la carta
	 * @param textoCarta             El texto que muestra lo que ocurre en esa carta
	 *                               (aparece cuando se pasa el cursor por encima de
	 *                               la carta)
	 * @param posicionX              La posición X de la carta
	 * @param posicionY              La posición Y de la carta
	 * @param estaInicialmenteEnMesa Booleano que nos dice si está inicialmente en
	 *                               el tablero o no.
	 */
	public CartaEnMapa(int id, String numeroCarta, String rutaImagen, String textoCarta, byte posicionX, byte posicionY,
			boolean estaInicialmenteEnMesa) {
