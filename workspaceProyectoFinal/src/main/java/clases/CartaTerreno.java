...
public class CartaTerreno extends CartaEnMapa {
	...
	/**
	 * Constructor de la clase CartaTerreno, que va a crear objetos los cuales van a contener un id, la ruta de la imagen de la 
	 * carta terreno, el número de carta, el texto descriptivo de la carta, la posición X de la carta, la posición Y de la carta, 
	 * y un booleano que nos va a decir si se encuentra la carta inicialmente en la mesa.
	 ...
	 * @param estaInicialmenteEnMesa Booleano que nos dice si la carta va a aparecer inicialmente o no, en el tablero
	 */
