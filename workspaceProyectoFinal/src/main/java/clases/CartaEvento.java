...
/**
 * Clase CartaEvento que hereda de la super clase CartaEnMapa y va a representar
 * las cartas de tipo evento que van a ir surgiendo como consecuencia de la
...
public class CartaEvento extends CartaEnMapa {
	...
	/**
	 * Constructor de la clase CartaEvento, en el cual se crea el objeto, que
	 * contendrá un id, un número de carta, la ruta de la imagen de la carta, el
	 * texto que contiene lo que está ocurriendo en la carta, la posición X de la
	 * carta, la posición Y, el id de la carta asociada a la carta de evento, y el
	 * id de la acción que desactiva la carta evento.
	 * 
	 ...
	 * @param textoCarta          El texto que describe lo que está ocurriendo en la
	 *                            carta
	 ...
	 */
	public CartaEvento(int id, String numeroCarta, String rutaImagen, String textoCarta, byte posicionX, byte posicionY,
			int idCartaAsociada, int idAccionDesactivada) {
